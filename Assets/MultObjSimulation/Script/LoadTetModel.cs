...
public class LoadTetModel : MonoBehaviour
{
    ...
    static bool useInteriorSpring = false;
    ...
    public LoadTetModel(string filename,bool UseInteriorSpring, GameObject gameobj)
    {
        fileName = filename;
        obj = gameobj;
    ...
    public static void LoadData(string filename, bool UseInteriorSpring, GameObject gameobj)
    {
        useInteriorSpring = UseInteriorSpring;
        fileName = filename;
        obj = gameobj;
    ...
    {
        string springpath;
        if(useInteriorSpring) springpath = fileName + ".springinterior";
        else springpath = fileName + ".springsurface";
        ...
        using (reader1)
        {
            ...
            do
            {
                ...
                if (line != null)
                {
                    ...
                    if (tmpPosPerRow.Length > 1) // if data
                    {
